...
export default function Injector(modules, parent) {
  ...
  function loadModule(moduleDefinition) {
    ...
    var moduleExports = /** @type {string[]} */ (moduleDefinition.__exports__);

    // private module
    if (moduleExports) {
      var nestedModules = /** @type {ModuleDeclaration[]} */ (moduleDefinition.__modules__);
  ...
  function bootstrap(moduleDefinitions) {
    moduleDefinitions.forEach(loadModule);
  }
